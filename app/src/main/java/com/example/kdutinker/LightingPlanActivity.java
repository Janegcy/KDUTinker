...
public class LightingPlanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String selectedIds = "";
    final CharSequence[] items = {"Bulb not lighting"," Flickering bulb"," Others "};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int index = 0; index < seats.length(); index++) {
            if (seats.charAt(index) == '/') {
                ...
                view.setId(count);
                view.setGravity(Gravity.CENTER);
                view.setBackgroundResource(R.drawable.good_bulb);
                view.setText(count + "");
                view.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 9);
    ...
    public void onClick(View view) {
        if ((int) view.getTag() == STATUS_AVAILABLE) {
            if (selectedIds.contains(view.getId() + ",")) {
                ...
                view.setBackgroundResource(R.drawable.bulb_reporting);
                AlertDialog.Builder builder = new AlertDialog.Builder(LightingPlanActivity.this);
                builder.setTitle("  Report issue on lighting .. in hall ..");
